...
public class OkHttpFieldLevelEncryptionInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        Request encryptedRequest = handleRequest(chain.request(), config); // encrypts payload info
        Response encryptedResponse = chain.proceed(encryptedRequest); // sends the request
        return handleResponse(encryptedResponse, config); // retrieves the response + decrypts
    }
